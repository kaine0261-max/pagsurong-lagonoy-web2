    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-semibold mb-6">Set Up Your Resort</h2>
                ...
                <form method="POST" action="{{ route('business.setup.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Resort Name -->
                        <div class="col-span-2">
                            <label for="business_name" class="block text-sm font-medium text-gray-700">Resort Name</label>
                        ...
                        <input type="hidden" name="business_type" value="resort">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                   placeholder="e.g. contact@yourresort.com"
                        ...
                        <!-- Resort Location -->
                        <div>
                            <x-location-select name="address" :required="true" :value="old('address')">Resort Location</x-location-select>
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="url" id="website" name="website" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                   placeholder="e.g. https://yourresort.com"
                                   value="{{ old('website') }}">
                            @error('website')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                      placeholder="Describe your resort, amenities, and offerings"
