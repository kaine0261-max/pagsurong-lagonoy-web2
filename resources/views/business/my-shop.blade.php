...
@if($business && $business->status === 'declined')
    <div class="bg-red-50 border-l-4 border-red-500 p-4 sm:p-6 mb-4 sm:mb-6 rounded-lg shadow-md mx-2 sm:mx-0">
        <div class="flex items-start">
            ...
            <div class="ml-3 sm:ml-4 flex-1">
                <h3 class="text-base sm:text-lg font-semibold text-red-800 mb-2">
                    Your Business Application Was Declined
                </h3>
                @if($business->decline_reason)
                    <div class="bg-white border border-red-200 rounded-md p-3 sm:p-4 mb-3 sm:mb-4">
                        ...
                        <p class="text-xs sm:text-sm text-gray-700 break-words">{{ $business->decline_reason }}</p>
                    </div>
                @endif
                        ...
                        <div class="space-y-3">
                            ...
                            @if(!empty($business->business_permit_path))
                                <div class="mt-3">
                                    ...
                                    <div class="space-y-1">
                                        @foreach($business->business_permit_path as $index => $permit)
