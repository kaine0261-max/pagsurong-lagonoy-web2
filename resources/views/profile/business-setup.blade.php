...
<body class="font-roboto text-gray-800 leading-relaxed">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="relative">
                            ...
                            <!-- Hidden File Input -->
                            <input type="file" id="profile_picture" name="profile_picture" accept="image/jpeg,image/jpg,image/png" class="hidden" onchange="handleFileSelect(event)">
                        </div>
    ...
    <!-- Enhanced Profile Upload JavaScript -->
    <script>
