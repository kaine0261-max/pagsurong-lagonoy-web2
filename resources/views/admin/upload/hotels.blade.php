...
@section('title', 'Upload Hotel')

@section('content')
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <h1 class="text-3xl font-serif font-bold text-gray-800 mb-2 text-center">Upload Hotel</h1>
    <p class="text-gray-600 text-center mb-8">Add a new hotel with all its details and images</p>
    ...
    <form action="{{ route('admin.hotels.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-lg rounded-2xl p-8 space-y-8">
        @csrf
        ...
        <!-- Full Info -->
        <div>
            <label for="full_info" class="block text-sm font-medium text-gray-700">Full Hotel Information</label>
        ...
        <div>
            ...
            <input type="file" name="images[]" id="images" multiple accept="image/jpeg,image/jpg,image/png" capture="environment" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
